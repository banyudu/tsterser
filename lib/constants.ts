import { convert_to_predicate, makePredicate, characters } from './utils'
...
export const PUNC_AFTER_EXPRESSION = makePredicate(characters(';]),:'))

export const RE_HEX_NUMBER = /^0x[0-9a-f]+$/i
export const RE_OCT_NUMBER = /^0[0-7]+$/
export const RE_ES6_OCT_NUMBER = /^0o[0-7]+$/i
export const RE_BIN_NUMBER = /^0b[01]+$/i
export const RE_DEC_NUMBER = /^\d*\.?\d*(?:e[+-]?\d*(?:\d\.?|\.?\d)\d*)?$/i

export const EX_EOF = {}
const _KEYWORDS_BEFORE_EXPRESSION = 'return new delete throw else case yield await'
export const KEYWORDS = makePredicate(_KEYWORDS)
export const KEYWORDS_BEFORE_EXPRESSION = makePredicate(_KEYWORDS_BEFORE_EXPRESSION)
export const KEYWORDS_ATOM = makePredicate(_KEYWORDS_ATOM)
export const OPERATOR_CHARS = makePredicate(characters('+-*&%=<>!?|~^'))
export const RE_NUM_LITERAL = /[0-9a-f]/i
export const RE_BIG_INT = /^(0[xob])?[0-9a-f]+n$/i
export const OPERATORS = makePredicate([
  'in',
  'instanceof',
  'typeof',
  'new',
...
export const WHITESPACE_CHARS = makePredicate(characters(' \u00a0\n\r\t\f\u000b\u200b\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u2028\u2029\u202f\u205f\u3000\uFEFF'))
export const NEWLINE_CHARS = makePredicate(characters('\n\r\u2028\u2029'))
export const PUNC_BEFORE_EXPRESSION = makePredicate(characters('[{(,;:'))
export const PUNC_CHARS = makePredicate(characters('[]{}(),;:'))
